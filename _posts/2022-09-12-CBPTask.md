...
This program will first indicate user to select a sport that they play or are interested in. Afterwards buttons  to next question. After the final question is answered there will be a button that will take you to the final page. The final page outputs which position is best for the sport that you selected in the first page.
